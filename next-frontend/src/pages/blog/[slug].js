        ...
        <div>
          <div class="container py-6 md:py-10">
            <div class="mx-auto max-w-4xl">
              ...
              <div class=" max-w-none pt-8">
                <div className="block  font-body text-lg font-bold uppercase text-primary ">
                  <u>Problem Statement :</u>
                </div>
                <div className="my-2 mx-2 block font-body text-xl font-bold">
                  {blog.metadesc}
                </div>
              </div>

              <div class="prose max-w-none pt-1">
                <div className="block  font-body text-lg font-bold uppercase text-primary ">
                  <u>Code:</u>
                </div>
                <div>
              ...
              <div class=" max-w-none pt-8">
                ...
                serializers={{
                  ...
                  li: ({ children }) => (
                    <li className="special-list-item my-5">{children}</li>
                  ),
                }}
              />
                </div>
              ...
              <div class=" max-w-none pt-8">
                ...
                <div>
                  <img
                    src={builder.image(blog.opimage).url()}
                    className="my-5 mx-3 item-center"
                    alt="Output-image"
                  />
                </div>
              </div>
