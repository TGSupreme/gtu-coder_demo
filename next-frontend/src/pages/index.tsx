    ...
    <>
      <>
        ...
        <div className="container flex items-center justify-between">
          <div>
            <a href="/">
              <h2 className='text-white text-3xl font-bold'>{profile.title}</h2>
            </a>
          </div>
                  ...
                  <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                    ...
                    <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                      ...
                      <a href={profile.twitterlink} className="pl-4">
                        <i className="bx bxl-twitter bxl-facebook-square text-2xl text-white hover:text-yellow"></i>
                      </a>
                      <a href={profile.gitlink} className="pl-4">
            ...
            <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
              <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                <h4 className="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
                  I'm {profile.name}, a student at Gujrat Technological
                  University
                </h4>
          ...
          <div className="bg-grey-50" id="blog">
            <div className="container py-16 md:py-20">
              ...
              <h4 className="pt-6 text-center font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl">
                Subjects Of GTU (IT-Dept.)
              </h4>

              <div className="mx-auto grid w-full grid-cols-1 gap-6 pt-12 sm:w-3/4 lg:w-full lg:grid-cols-3 xl:gap-10">
                {/* {blogs.map((item) => {
              return <Link key={item.slug} href={"/blog/" + item.slug.current} className="shadow cursor-pointer">
              <div style={{"backgroundImage": "url(/assets/img/post-01.jpg)"}}
              ...
              <div className="bg-white py-6 px-5 xl:py-8">
                ...
                <a href="/blogs" className="shadow">
                  <div
                    style={{
                      backgroundImage: "url(/assets/img/bg-subject.jpg)",
                    }}
                    className="group relative h-72 bg-cover bg-center bg-no-repeat sm:h-84 lg:h-64 xl:h-72"
                  >
                  ...
                  <div className="bg-white py-6 px-5 xl:py-8">
                    ...
                    <span className="block pt-2 font-body text-grey-20">
                      Quick Sloution For All Placticals
                    </span>
                  </div>
                </a>
                <a href="/blogs" className="shadow">
          ...
          <div className="container py-16 md:py-20" id="contact">
            ...
            <div className="mx-auto w-full pt-5 text-center sm:w-2/3 lg:pt-6">
              <p className="font-body text-grey-10">
                Feel free to contact us if you have any question.In the case of no response contact on our social pages.34
              </p>
            </div>
        ...
        {/* <div className="bg-primary">
          <div className="container flex flex-col justify-between py-6 sm:flex-row">
            <p className="text-center font-body text-white md:text-left">
              © Copyright {new Date().getFullYear()}. All right reserved, GTU
              Coder.
            </p>
